...
1. Clone the repository or download the necessary files:
    ...
    ```bash
    git clone https://github.com/vUnkname/cdn-ip-ranges.git
    ```
...
- Cloudflare IP ranges
   ```
   https://raw.githubusercontent.com/vUnkname/cdn-ip-ranges/main/cloudflare.json
   ```
- Gcore IP ranges
   ```
   https://raw.githubusercontent.com/vUnkname/cdn-ip-ranges/main/gcore.json
   ```
- Fastly IP ranges
   ```
   https://raw.githubusercontent.com/vUnkname/cdn-ip-ranges/main/fastly.json
   ```
